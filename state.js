...
(function(root) {
   ...
   */
  function createPlayer(id, name, color, startX, startY, facingX, facingY) {
    return {
      id: id,
      name: name,
      color: color,
  ...
  function createInitialState(customArena) {
    ...
    return {
      ...
      players: [
        createPlayer(1, 'Player 1', '#00f0ff', p1StartX, p1StartY, 1, 0),
        createPlayer(2, 'Player 2', '#ff2a6d', p2StartX, p2StartY, -1, 0),
      ],
